...
export function scoreTask1(
  ...
  const gates: GateResult[] = [
    ...
    {
      // Accuracy is measured over what was typed, so without this gate a short
      // perfect prefix would score well above the pass mark.
      label: 'Passage completion',
      actual: metrics.completionPercentage,
      required: settings.minCompletion,
      unit: '%',
      passed: metrics.completionPercentage >= settings.minCompletion,
    },
  ]
