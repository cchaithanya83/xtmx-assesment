import type { Attempt, Candidate, TaskId, TrainerSettings } from './types.ts'
import { BATCHES, FIRST_NAMES, LAST_NAMES, LOCATIONS, TRAINERS } from './pools.ts'
import { TASKS } from './tasks.ts'
import { createRng, clamp, pick, randInt, round, uid, type Rng } from './core.ts'
